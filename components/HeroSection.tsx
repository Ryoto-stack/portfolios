...
const Shapes = () => (
  <>
    ...
    <svg
      className="absolute top-[20%] left-[%] -z-10"
      width="49"
      height="40"
      viewBox="0 0 49 40"
      fill="none"
...
const ShapeSeven = () => (
  <svg
    className="absolute top-0 left-0 lg:-left-[100px] -z-30"
    width="291"
    height="168"
    viewBox="0 0 291 168"
    fill="none"
...
const HeroSection = () => {
  return (
    <section className="py-14 md:py-32 w-full bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-10">
      <Shapes />
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-12 gap-8 items-center">
          <div className="col-span-12 lg:col-span-7 xl:col-span-6 text-center lg:text-start mb-12 lg:mb-0">
            <h2 className="text-3xl font-bold leading-tight lg:text-7xl mb-6 w-full">
              Kent Cedric Escala
            </h2>
            <div className="max-w-xl">
              <p className="text-[17px] leading-relaxed opacity-80 my-12">
                Based in the Philippines, I&apos;m a front-end developer focused on
                building accessible web applications. I strive to enhance user
                experience through thoughtful design and effective solutions. My
                goal is to deliver both functionality and user satisfaction.
              </p>
            </div>
          ...
          <div className="col-span-12 lg:col-span-5 relative text-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute w-[500px] h-[500px] left-6 lg:col-span-5 right-9 top-0 bg-slate-100  rounded-full -z-20"></div>
            </div>
          </div>
        </div>
      </div>
